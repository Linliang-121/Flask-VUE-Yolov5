          ...
          <div class="demo-image__preview1">
            ...
            >
              <el-image
                ...
                style="border-radius: 30px 3px 0 0"
              >
                <div slot="error">
      ...
      <div id="info_patient">
        ...
        <el-card style="border-radius: 8px">
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检测到的缺陷" name="first">
              <!-- 表格存放特征值 -->
              <el-table
                :data="feature_list"
                height="390"
                ...
                lazy
              >
                <el-table-column label="缺陷类别" width="250px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[2] }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="缺陷大小" width="250px">
                  <template slot-scope="scope">
